...
export default function CategoryPage() {
  ...
  const products = [
    ...
    },
    {
      ...
      color: ["green", "grey"],
      tags: ["Award-winning"],
      image: "https://via.placeholder.com/300/8FBBAF",
    },
    {
      id: 3,
  ...
  const filters = ["all", "green", "brown", "grey", "blue"];

  // Filter products based on color
  const filteredProducts =
    selectedColor === "all"
      ? products
      : products.filter((p) => p.color.includes(selectedColor));
    ...
    <div className="container mx-auto px-6 py-10">
      ...
      <div className="flex flex-wrap">
        ...
        <section className="w-full md:w-3/4">
          <h2 className="text-2xl font-semibold mb-4">All Sofas</h2>
                ...
                <div className="p-4">
                  ...
                  <div className="mt-2">
                    {product.tags.map((tag, idx) => (
                      <span
                        key={idx}
                        className="bg-green-100 text-green-600 text-sm px-2 py-1 rounded mr-2"
                      >
                        {tag}
                      </span>
                    ))}
      ...
      <div className="mt-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {["Mattresses", "Sofa Beds", "Bed Bases", "Sofas"].map((category) => (
            <div
              key={category}
      ...
      <div className="mt-10">
        ...
        <div className="flex space-x-4 overflow-x-auto">
          {products.map((product) => (
            <div
              key={product.id}
              className="border rounded-lg min-w-[200px] shadow-sm hover:shadow-md transition"
            >
              <img
                src={product.image}
                alt={product.name}
