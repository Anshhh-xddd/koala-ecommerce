...
const ProductDetail = () => {
    ...
    useEffect(() => {
        const fetchProductData = async () => {
            const fetchedProduct = {
                ...
                images: {
                    "Single": "https://au.koala.com/cdn/shop/files/SOFABED_WOODLAND_1.5SEATER_5.webp?v=1727275118&width=720",
                    "Queen": "https://au.koala.com/cdn/shop/files/6a80e18f883fe8e0c16fb17c6724bcf5.png?v=1725501907&width=720",
                    "King": "https://au.koala.com/cdn/shop/files/addf95a2093b626b6d202b299bf8bca4.png?v=1725500695&width=720",
                    "Super King": "https://au.koala.com/cdn/shop/articles/best-sofa-bed.jpg?v=1728975262",
                },
                image: "https://au.koala.com/cdn/shop/files/d52c987f6e8ab40648a111a21b8da172.png?v=1725501367&width=720",
            };
    ...
    const handleSizeChange = (newSize) => {
        ...
        setProduct((prevProduct) => ({
            ...prevProduct,
            image: prevProduct.images[newSize],
        }));
    };
            ...
            <div className="lg:grid lg:grid-cols-2 lg:gap-12">
                <div className="flex flex-col items-center space-y-6 lg:space-y-0 lg:items-start">
                    ...
                    <div className="grid grid-cols-4 gap-4 mt-4">
                        {Object.keys(product.images).map((sizeKey) => (
                            <img
                                key={sizeKey}
                                src={product.images[sizeKey]}
                                alt={`${sizeKey} Thumbnail`}
                                className={`w-full rounded-md shadow-sm cursor-pointer hover:opacity-80 ${
                                    size === sizeKey ? "ring-2 ring-green-600" : ""
                                }`}
