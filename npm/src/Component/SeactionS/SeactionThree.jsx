...
const products = [
    {
        ...
        price: 650.99,
        rating: 4.5,
        imageUrl: "npm/src/assets/secition/one/one.png",
    },
    {
        id: 2,
        title: "HP Spectre x360 15",
    ...
    return (
        <div className="relative w-full bg-gray-200 py-8 mt-4 overflow-hidden" {...handlers}>
            ...
            <div className="flex items-center justify-between px-6 mb-6">
                <h2 className="text-left text-4xl font-extrabold font-serif">New Arrivals</h2>
            ...
            <div className="flex overflow-x-auto no-scrollbar px-[50px] gap-4 mt-6">
                {["Featured", "Bedroom", "Living Room", "Outdoor"].map(
                    (category) => (
                        <button
                            key={category}
